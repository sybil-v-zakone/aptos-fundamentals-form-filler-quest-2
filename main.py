...
from settings import SLEEP_TIME, ADDRESSES_FILE_PATH, ERROR_SLEEP_TIME
...
def fill_form(address: str):
    logger.info(f'Filling form for {address}')
    value = {"entry.908064693": address}
